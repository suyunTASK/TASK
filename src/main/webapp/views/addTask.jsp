        ...
        <div class="add-task-container">
            ...
            <form action="/addTask" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="taskTitle" name="taskTitle" required placeholder="업무 제목을 입력하세요">
                </div>

                <div class="form-group">
                    <label for="taskDescription">업무 설명</label>
                    <textarea id="taskDescription" name="taskDescription" placeholder="업무에 대한 상세 설명을 입력하세요"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="assignee-selection">
                        <label class="assignee-option">
                            <input type="checkbox" name="assignees" value="김철수">
                            김철수
                        </label>
                        <label class="assignee-option">
                            <input type="checkbox" name="assignees" value="이영희">
                            이영희
                        </label>
                        <label class="assignee-option">
                            <input type="checkbox" name="assignees" value="박민수">
                            박민수
                        </label>
                        <label class="assignee-option">
                            <input type="checkbox" name="assignees" value="정수진">
                            정수진
                        </label>
                        <label class="assignee-option">
                            <input type="checkbox" name="assignees" value="최동훈">
                            최동훈
                        </label>
                    </div>
                    <div class="assignee-selected-list">선택된 담당자: <span id="selectedAssignees">없음</span></div>
                </div>

                <div class="form-group">
                    <label>우선순위</label>
                    <input type="hidden" id="priorityInput" name="priority" required>
                    <div class="priority-selection">
                        <span class="priority-badge priority-high" data-priority="high">높음</span>
                        <span class="priority-badge priority-medium" data-priority="medium">중간</span>
                        <span class="priority-badge priority-low" data-priority="low">낮음</span>
                    </div>
                </div>
